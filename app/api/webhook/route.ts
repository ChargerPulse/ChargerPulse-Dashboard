  ...
  const body = `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #020817; color: #e2e8f0;">
      <div style="background: linear-gradient(135deg, #00d4ff, #a855f7); padding: 40px; text-align: center; border-radius: 12px 12px 0 0;">
        ...
        <p style="color: rgba(255,255,255,0.8); margin: 8px 0 0;">Your EV chargers are now protected 24/7</p>
      </div>
      <div style="background: #0d1421; padding: 40px; border: 1px solid rgba(255,255,255,0.08);">
        ...
        <p style="color: #94a3b8; line-height: 1.7;">Thank you for subscribing to <strong style="color: #00d4ff;">ChargerPulse ${planName}</strong>!</p>
        <div style="background: rgba(0,212,255,0.06); border: 1px solid rgba(0,212,255,0.2); border-radius: 12px; padding: 24px; margin: 24px 0;">
          ...
          <p style="color: #94a3b8; margin: 0 0 8px;"><strong style="color: #e2e8f0;">2.</strong> Click + ADD to register your charger</p>
          <p style="color: #94a3b8; margin: 0;"><strong style="color: #e2e8f0;">3.</strong> Point your charger to: wss://chargerpulse-1.onrender.com/YOUR_ID</p>
        </div>
        <div style="text-align: center; margin: 32px 0;">
          <a href="https://chargerpulse-dashboard.onrender.com/dashboard" style="background: linear-gradient(135deg, #00d4ff, #a855f7); color: white; padding: 14px 36px; border-radius: 10px; text-decoration: none; font-weight: 800; font-size: 15px; display: inline-block;">
            Go to My Dashboard
          </a>
        </div>
        <p style="color: #64748b; font-size: 13px;">Need help? Just reply to this email.<br/>
        <strong style="color: #e2e8f0;">Senzo Ngoyi</strong> — Founder, ChargerPulse</p>
      </div>
